public class E5_27 {
	public static void main(String[] args) {		
		...
		{
			if (isPrimeNumber(reverse(number)) && isPrimeNumber(number) && isNotPalindrome(number) )
			{				
	...
	//  Return true if number is not palindrome
	public static boolean isNotPalindrome(int number) {	  	
		return (reverse(number) == number)? false : true;		  
	  }
